...
values(?, ?, ?, ?)"""
    ...
    def get_winners_count(self, prize_id):
        ...
        with conn:
            cur = conn.cursor()
            cur.execute('SELECT user_name, COUNT(*) as winner_count FROM winners WHERE prize_id = ?', (prize_id, ))
    ...
    def get_rating(self):
        ...
        with conn:
            cur = conn.cursor()
            cur.execute('''
    SELECT projects.project_name, AVG(ratings.rating) as avg_rating FROM projects
    JOIN ratings ON projects.project_id = ratings.project_id
